...
public class TC_16_P_Extra_full_offline_payment 
{
	 ...
	 WebDriver driver;
		...
		@Test(priority= 1 )
		public void Extra_and_full_offline_payment() throws InterruptedException
		{
			Offline_payment OP= new Offline_payment(driver);
			OP.part_payment_offline("20000","856488");
