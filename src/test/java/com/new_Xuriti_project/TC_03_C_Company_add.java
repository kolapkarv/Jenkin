...
import com.new_Xuriti_project.Create_company;
...
public class TC_03_C_Company_add
{
...
WebDriver driver;
	...
	@Test
	public void new_company_create() throws InterruptedException
	{
		Create_company CA= new Create_company(driver);
		CA.new_company_add("18AABCU9603R1ZM");
	}
}
